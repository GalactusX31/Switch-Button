--[[
  "Keybindused" is only used to control the script (on_gui_opened), so it only work when his value is 0,
...
local function onKey(event)
  ...
  keybindused = 1
  if entity and entity.valid and entity.name == 'switchbutton' then
